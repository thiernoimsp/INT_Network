...
CSV.write("Spatial_Dependencies.csv",  DataFrame(Spatial_Dependencies), header=["m", "d", "P"])
...
CSV.write("Temporal_Dependencies.csv",  DataFrame(Temporal_Dependencies), header=["m", "P"])
...
CSV.write("/home/tbn/Brazil_note/These_Telemetry/Implementation_INT/Data_Analysis/INT_Draft_2/Items_12.csv",  DataFrame(Items_12), header=["Device", "Item", "flow"])
...
CSV.write("/home/tbn/Brazil_note/These_Telemetry/Implementation_INT/Data_Analysis/INT_Draft_2/Flows.csv",  DataFrame(Flows), writeheader=false)
